...
@echo. & echo [INFO] Done (#1) -- FULL installer for Win7+ ready.
...
@echo. & echo [INFO] Done (#2) -- MINI installer for Win7+ ready.
...
@echo. & echo [INFO] Done (#3) -- Console zip-package for Win/Mac/Linux ready.
...
@rem @echo. & echo Done {#4} -- Special zip-package for Mono platform ready.
